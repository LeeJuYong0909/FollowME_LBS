...
public class BeaconAdapter{
    ...
    void calculateLocation() {
        ...
        Trilateration tr = new Trilateration(BeaconList.getTM_K_lat(), BeaconList.getTM_K_lng(), selectBeacons[0], selectBeacons[1], selectBeacons[2]);
    ...
    void location() {
        ...
        LatLng SEOUL = new LatLng(BeaconList.getWGS_K_lat(), BeaconList.getWGS_K_lng());
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(SEOUL);
        System.out.println("점 위치 : " + SEOUL.latitude +", "+ SEOUL.longitude);
        markerOptions.title("현 위치" + BeaconList.getFloor());
