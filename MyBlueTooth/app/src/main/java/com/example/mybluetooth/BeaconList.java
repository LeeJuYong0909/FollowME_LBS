...
public class BeaconList {
    ...
    public void kalman(boolean check) {
        double x = TM_lat;
        double y = TM_lng;
        ...
        //주석 풀 경우 칼만필터 미적용
        if (check) {
            System.out.println("점 칼만필터 적용");
            filteredX = x;
            filteredY = y;
        }
        else{
            System.out.println("점 칼만필터 미적용");
        }
        //이전 값 저장
    ...
    // getter
    public int size()               { return numOfData; }
    public double getTM_lat()       { return TM_lat; }
    public double getTM_lng()       { return TM_lng; }
    public double getTM_K_lat()     { return TM_K_lat; }
    public double getTM_K_lng()     { return TM_K_lng; }
    public double getWGS_lat()      { return WGS_lat; }
    public double getWGS_lng()      { return WGS_lng; }
    public double getWGS_K_lat()    { return WGS_K_lat; }
    public double getWGS_K_lng()    { return WGS_K_lng; }
    public String getFloor() { return floor; }

    // setter
    public void setFloor(String argFloor) { this.floor = argFloor;}
